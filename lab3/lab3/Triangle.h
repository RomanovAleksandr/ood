...
public:
    ...
    bool ContainsPoint(sf::Vector2i point)
    {
        ...
        float A1 = area((float)point.x, (float)point.y, v2.x, v2.y, v3.x, v3.y);
        /* Calculate area of triangle PAC */
        float A2 = area(v1.x, v1.y, (float)point.x, (float)point.y, v3.x, v3.y);
        /* Calculate area of triangle PAB */
        float A3 = area(v1.x, v1.y, v2.x, v2.y, (float)point.x, (float)point.y);
